    ...
    <div>
        <main id="main" class="main">
            ...
            <div class="d-flex mt-5">
                <div class="">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalThem">Thêm
                        truyện</button>
                </div>
                <div class="w-75">
                    <div class="container">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-2 fw-bold">Giới thiệu <span class="text-danger">*</span></div>
                    <textarea class="form-control" v-model="newName"></textarea>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                    <button type="button" class="btn btn-primary" @click="addStory">Thêm</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        updateSelectedCategoryIds(id) {
            const idIndex = this.selectedCategoryIds.findIndex(categoryId => categoryId === id)
            if (idIndex === -1) {
        ...
        async addStory() {
            try {
                ...
                const response = await axios.post('http://localhost:8000/api/home/add', newStoryData);
