            ...
            <ul class="responsive-table">
              ...
              <li class="table-row" v-for="story in stories" :key="story.id">
                <div class="col col-3 text-center">
                  <img :src="'data:image/jpeg;base64,' + story.avt" alt="Story Avatar" style="max-width: 100px; max-height: 50px" />
                </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="text-center mb-3">
            <img v-if="detailStory && detailStory.avt" :src="'data:image/jpeg;base64,' + detailStory.avt" alt="Story Avatar" style="max-width: 400px; max-height: 150px" class="mx-auto" />
          </div>
      ...
      swal
        ...
        .then((result) => {
          if (result.isConfirmed) {
            axios
              .delete(this.apiUrl + `/api/admin/remove/${deleteStoryId}`)
              .then((response) => {
                swal.fire({
                  title: "Đã xóa",
